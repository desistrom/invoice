        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col sub-invoice">
            <div class="row header-top">
                ...
                <div class="col-md-4 col-sm-4 col-xs-4 header-top-right">
                    <div class="filter-image">
                        <h1 class="text-invoice text-blue">INVOICE </h1></div>
                </div>
            </div>
            <div class="row header-line">
                ...
                <div class="col-md-8 col-sm-8 col-xs-10 none-padding">
                    <div class="col col-md-4 col-sm-4 col-xs-4">
                        <div class="shape-line bg-blue-dark"></div>
                    </div>
                    <div class="col col-md-2 col-sm-2 col-xs-2 none-padding">
                        <div class="shape-segitiga segitiga-blue"></div>
                    </div>
                    <div class="col col-md-6 col-sm-6 col-xs-6 none-padding shape-persegi bg-blue-dark">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="bg-blue-light">Rp. <?=$invoice['harga'];?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="bg-blue-light">Rp. <?=$pajak = ($result['pajak']/100)*$invoice['harga'];?></td>
                                </tr>
                                <tr>
                                    <td class="text-right text-bold bg-color-default">Total Amount Due</td>
                                    <td class="bg-color-green-dark bg-blue-dark" style="color: white;">Rp. <?=$pajak+$invoice['harga'];?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div class="row footer">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 text-footer">
                    <h3 class="text-center text-bold text-blue">THANK YOU FOR YOUR BUSINESS</h3></div>
            </div>
        </div>
    </div>
