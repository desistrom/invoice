        ...
        <div class="col-md-12 col-sm-12 col-xs-12 sub-invoice5">
            <div class="row header-top">
                <div class="col-md-7 col-sm-7 col-xs-7 header-top-right">
                    <div class="img-filter"><img src="<?=base_url();?>assets/file/<?=$result['logo'];?>"></div>
                </div>
            ...
            <div class="row header-center">
                <div class="col-md-4 col-sm-4 col-xs-4 sub-header-center sub-header-center-left">
                    ...
                    <div class="col col-md-8 col-sm-8 col-xs-8 ribbon-long"></div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-4 sub-header-center sub-header-center-center-center text-bold">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="tb-cell-right">Rp. 1.000.000</td>
                                </tr>
                                <tr>
                                    <td class="text-right text-bold">Total </td>
                                    <td class="tb-cell-right text-bold">Rp. 1.000.000</td>
                                </tr>
                                <tr>
                                    <td class="text-right text-bold">Tax VAT 10%</td>
                                    <td class="tb-cell-right text-bold">Rp. 1.00.000</td>
                                </tr>
                                <tr>
                                    <td class="text-right text-bold tb-cell-foot-left">Total Amount Due</td>
                                    <td class="tb-cell-foot-right bg-red-dark text-bold">Rp. 1.100.000</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div class="row footer-line">
                <div class="col-md-8 col-sm-8 col-xs-8 footer-line-left none-padding">
                ...
                <div class="col-md-2 col-sm-2 col-xs-2 footer-line-right none-padding text-center"><img src="<?=base_url();?>assets/file/<?=$result['logo'];?>"></div>
            </div>
        </div>
    </div>
