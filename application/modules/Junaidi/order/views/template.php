...
<html lang="en">
  <head>
    ...
    <!-- iCheck -->
    <link href="<?=site_url('assets/jun');?>/vendors/iCheck/skins/flat/green.css" rel="stylesheet">
	
    <!-- bootstrap-progressbar -->
    <link href="<?=site_url('assets/jun');?>/vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet">
    <!-- JQVMap -->
    <link href="<?=site_url('assets/jun');?>/vendors/jqvmap/dist/jqvmap.min.css" rel="stylesheet"/>
    <!-- bootstrap-daterangepicker -->
    <link href="<?=site_url('assets/jun');?>/vendors/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet">
